	...
	<body>
			<form action="../addYuangongxinxi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="30" colspan="2" background="images/table_header.gif">添加员工信息</td>
						</tr>
						<tr ><td width="200">工号：</td><td><input name='gonghao' type='text' id='gonghao' onblur='hsgcheck()' class="form-control" value=''  />&nbsp;*<label id='clabelgonghao' style='margin-top:16px;' /></td></tr>
