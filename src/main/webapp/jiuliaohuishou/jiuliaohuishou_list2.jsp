        ...
        <td>
            <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
                <tr align="left" bgcolor="#F2FDFF">
                    <td colspan="17" background="../images/table_header.gif">旧料回收列表</td>
                </tr>
            </table>
        </td>
    </tr>
                ...
                <tr align="right" bgcolor="#ebf0f7">
                    <td colspan="21">
                        <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1">
                            <tr align="left">
                                <td colspan="17">
                                    <form action="../jiuliaohuishou/jiuliaohuishouList2.do" name="myform" method="post">
                            ...
                            <c:forEach items="${list }" var="u">
                                ...
                                <tr align="center" bgcolor="#FFFFFF">
                                    ...
                                    <td height="45" align="center">
                                        <c:if test="${u.huifu==null||u.huifu==''}">
                                            <a class="btn btn-info btn-small"
                                               href="../jiuliaohuishou/doUpdateJiuliaohuishou.do?id=${u.id }">编辑</a>
                                            <a class="btn btn-info btn-small"
                                               href="../jiuliaohuishou/deleteJiuliaohuishou.do?id=${u.id }"
                                               onclick="{if(confirm('确定要取消吗?')){return true;}return false;}">取消</a>
                                        </c:if>
                                        <a class="btn btn-info btn-small"
                                           href="../jiuliaohuishou/jiuliaohuishouDetail.do?id=${u.id }">详细</a></td>
                                </tr>
                            </c:forEach>
                        </table>
                    </td>
...
<p align="center" class="fy"><c:if test="${sessionScope.p==1 }">
    <c:if test="${page.page>1}">
        <a href="jiuliaohuishouList2.do?page=1">首页</a>
        <a href="jiuliaohuishouList2.do?page=${page.page-1 }"> 上一页</a> </c:if>
    <c:if test="${page.page<page.totalPage}">
        <a href="jiuliaohuishouList2.do?page=${page.page+1 }">下一页</a>
        <a href="jiuliaohuishouList2.do?page=${page.totalPage }">末页</a> </c:if>
</c:if>
</p>
