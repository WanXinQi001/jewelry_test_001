...
<script language="javascript">
    ...
    <%--function gows() {--%>
    <%--    document.location.href = "../shangpinxinxi/shangpinxinxi_add.jsp?id=<%=id%>";--%>
    <%--}--%>
...
<form action="../updateShangpinxinxi.do" name="form1" method="post">
    <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" style="border-collapse:collapse"
           bgcolor="#F2FDFF">
        <tr bgcolor="#E7E7E7">
            <td height="30" colspan="2" background="images/table_header.gif">修改商品信息<input type="hidden" name="id"
                                                                                          value="${shangpinxinxi.id}"/>
            </td>
        </tr>
        <tr>
        ...
        <script language="javascript">document.form1.caizhi.value = '${shangpinxinxi.caizhi}';</script>
        <script language="javascript">document.form1.kezhong.value = '${shangpinxinxi.kezhong}';</script>
        <script language="javascript">document.form1.wupindanjia.value = '${shangpinxinxi.wupindanjia}';</script>
        <script language="javascript">document.form1.tupian.value = '${shangpinxinxi.tupian}';</script>
        <script language="javascript">document.form1.jianshu.value = '${shangpinxinxi.jianshu}';</script>
        <script language="javascript">document.form1.gonghao.value = '${shangpinxinxi.gonghao}';</script>
        <script language="javascript">document.form1.xingming.value = '${shangpinxinxi.xingming}';</script>
        <script language="javascript">document.form1.bumen.value = '${shangpinxinxi.bumen}';</script>
        ...
        <script language="javascript">document.form1.huodejifen.value = '${shangpinxinxi.huodejifen}';</script>
