...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <td>${u.huodejifen}</td>
                              ...
                              <td align="center"> <a class="btn btn-info btn-small" href='../shangpingoumai/shangpingoumai_add.jsp?id=${u.id}'>添加商品购买</a> <a class="btn btn-info btn-small" href="spxxDetail.do?id=${u.id}" target="_blank">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
