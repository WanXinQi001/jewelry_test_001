        ...
        <td>
            <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
                <tr align="left" bgcolor="#F2FDFF">
                    <td colspan="17" background="images/table_header.gif">以旧换新列表</td>
                </tr>
            </table>
        </td>
    </tr>
                ...
                <tr align="right" bgcolor="#ebf0f7">
                    <td colspan="21">
                        <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1">
                            <tr align="left">
                                <td colspan="17">
                                    <form action="yijiuhuanxinList2.do" name="myform" method="post">
                                        查询 编号：<input name="bianhao" type="text" id="bianhao" class="form-control2"/>
                                        物品名称：<input name="wupinmingcheng" type="text" id="wupinmingcheng"
                                                    class="form-control2"/>
                            ...
                            <c:forEach items="${list }" var="u">
                                ...
                                <tr align="center" bgcolor="#FFFFFF">
                                    ...
                                    <td height="45" align="center"><a class="btn btn-info btn-small"
                                                                      href="doUpdateYijiuhuanxin.do?id=${u.id }">编辑</a>
                                        <a class="btn btn-info btn-small" href="deleteYijiuhuanxin.do?id=${u.id }"
                                           onclick="{if(confirm('确定要取消吗?')){return true;}return false;}">取消</a> <a
                                                class="btn btn-info btn-small" href="yijiuhuanxinDetail.do?id=${u.id }">详细</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </table>
...
<p align="center" class="fy"><c:if test="${sessionScope.p==1 }">
    <c:if test="${page.page>1}">
        <a href="yijiuhuanxinList2.do?page=1">首页</a>
        <a href="yijiuhuanxinList2.do?page=${page.page-1 }"> 上一页</a> </c:if>
    <c:if test="${page.page<page.totalPage}">
        <a href="yijiuhuanxinList2.do?page=${page.page+1 }">下一页</a>
        <a href="yijiuhuanxinList2.do?page=${page.totalPage }">末页</a> </c:if>
</c:if>
</p>
