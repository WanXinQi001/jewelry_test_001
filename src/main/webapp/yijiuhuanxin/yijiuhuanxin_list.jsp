...
<html xmlns="http://www.w3.org/1999/xhtml">
				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td height="30" colspan="17" background="images/table_header.gif">以旧换新列表</td>
						</tr>
					</table>
				</td>
			</tr>
						...
						<tr align="left" >
							<td colspan="17">
								<form action="yijiuhuanxinList.do" name="myform" method="post">
									查询   编号：<input name="bianhao" type="text" id="bianhao" class="form-control2" />  物品名称：<input name="wupinmingcheng" type="text" id="wupinmingcheng" class="form-control2" />
    ...
    <td align="center"> ${u.addtime } </td>
                              <td align="center"><a class="btn btn-info btn-small" href="doUpdateYijiuhuanxinlb.do?id=${u.id }">回复</a>  <a class="btn btn-info btn-small" href="deleteYijiuhuanxin.do?id=${u.id }"
										onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a> <a class="btn btn-info btn-small" href="yijiuhuanxinDetail.do?id=${u.id}">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <c:if test="${page.page>1}">
              <a href="yijiuhuanxinList.do?page=1" >首页</a>
             <a href="yijiuhuanxinList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="yijiuhuanxinList.do?page=${page.page+1 }">下一页</a>
			<a href="yijiuhuanxinList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
