...
<html xmlns="http://www.w3.org/1999/xhtml">
				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td height="30" colspan="17" background="images/table_header.gif">财务管理列表</td>
						</tr>
					</table>
				</td>
			</tr>
    ...
    <td>${u.faburen}</td>
                              ...
                              <td align="center"><a class="btn btn-info btn-small" href="doUpdateCaiwuguanli.do?id=${u.id }">编辑</a>  <a class="btn btn-info btn-small" href="deleteCaiwuguanli.do?id=${u.id }"
										onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a> <a class="btn btn-info btn-small" href="caiwuguanliDetail.do?id=${u.id}">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
...
while(RS_result.next()){
						...
						zonglirunz=zonglirunz+Float.valueOf(RS_result.getString("zonglirun")).floatValue();
