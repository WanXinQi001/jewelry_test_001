...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <td>${u.faburen}</td>
                              ...
                              <td height="45" align="center"><a class="btn btn-info btn-small" href="doUpdateCaiwuguanli.do?id=${u.id }">编辑</a>  <a class="btn btn-info btn-small" href="deleteCaiwuguanli.do?id=${u.id }"
