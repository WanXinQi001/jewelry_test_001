...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <td>${u.faburen}</td>
                              ...
                              <td align="center"> <!--lianjie1--> <a class="btn btn-info btn-small" href="caiwuguanliDetail.do?id=${u.id}">��ϸ</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
...
while(RS_result.next()){
		...
		����������:<%=zonglirunz%>�� 
		 ...
		 <c:if test="${page.page>1}">
              <a href="caiwuguanliList.do?page=1" >��ҳ</a>
             <a href="caiwuguanliList.do?page=${page.page-1 }"> ��һҳ</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="caiwuguanliList.do?page=${page.page+1 }">��һҳ</a>
			<a href="caiwuguanliList.do?page=${page.totalPage }">ĩҳ</a>		    </c:if>		
	</c:if>
	</p>
