...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <td align='center'>${u.issh} <input type="button" value="审核" onClick="javascript:location.href='sh.jsp?id=${u.id}&yuan=${u.issh}&tablename=huiyuanxinxi'"/></td>
                              ...
                              <td align="center"><a class="btn btn-info btn-small" href="doUpdateHuiyuanxinxi.do?id=${u.id }">编辑</a>  <a class="btn btn-info btn-small" href="deleteHuiyuanxinxi.do?id=${u.id }"
										onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a> <a class="btn btn-info btn-small" href="huiyuanxinxiDetail.do?id=${u.id}">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
