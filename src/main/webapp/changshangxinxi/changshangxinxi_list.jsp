...
<html xmlns="http://www.w3.org/1999/xhtml">
				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td height="30" colspan="17" background="images/table_header.gif">厂商信息列表</td>
						</tr>
					</table>
				</td>
			</tr>
    ...
    <td>${u.dizhi}</td>
                              ...
                              <td align="center"><a class="btn btn-info btn-small" href="doUpdateChangshangxinxi.do?id=${u.id }">编辑</a>  <a class="btn btn-info btn-small" href="deleteChangshangxinxi.do?id=${u.id }"
										onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a> <a class="btn btn-info btn-small" href="changshangxinxiDetail.do?id=${u.id}">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <c:if test="${page.page>1}">
              <a href="changshangxinxiList.do?page=1" >首页</a>
             <a href="changshangxinxiList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="changshangxinxiList.do?page=${page.page+1 }">下一页</a>
			<a href="changshangxinxiList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
