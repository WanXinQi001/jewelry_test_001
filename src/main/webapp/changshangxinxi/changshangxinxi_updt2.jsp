...
<link rel="stylesheet" href="../images/hsgcommon/common.css" type="text/css">
	...
	<body>
			<form action="updateChangshangxinxi2.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改厂商信息<input type="hidden" name="id" value="${changshangxinxi.id}" /></td>
						</tr>
