...
<%
    ...
    // 按日统计，添加筛选条件只查询当月数据
    String dailySql = "SELECT shangpinmingcheng, COUNT(goumaishuliang) as bbb, DATE_FORMAT(goumairiqi, '%Y-%m-%d') as date " +
            "FROM shangpingoumai " +
            "WHERE YEAR(goumairiqi) =? AND MONTH(goumairiqi) =? " +
            "GROUP BY shangpinmingcheng, DATE_FORMAT(goumairiqi, '%Y-%m-%d')";
    ...
    while (dailyRS.next()) {
        ...
        String productName = dailyRS.getString("shangpinmingcheng");
    ...
    // 按月统计
    String monthlySql = "SELECT shangpinmingcheng, COUNT(goumaishuliang) as bbb, DATE_FORMAT(goumairiqi, '%Y-%m') as month " +
            "FROM shangpingoumai " +
            "GROUP BY shangpinmingcheng, DATE_FORMAT(goumairiqi, '%Y-%m')";
    ...
    while (monthlyRS.next()) {
        ...
        String productName = monthlyRS.getString("shangpinmingcheng");
    ...
    // 按年统计
    String yearlySql = "SELECT shangpinmingcheng, COUNT(goumaishuliang) as bbb, DATE_FORMAT(goumairiqi, '%Y') as year " +
            "FROM shangpingoumai " +
            "GROUP BY shangpinmingcheng, DATE_FORMAT(goumairiqi, '%Y')";
    ...
    while (yearlyRS.next()) {
        ...
        String productName = yearlyRS.getString("shangpinmingcheng");
