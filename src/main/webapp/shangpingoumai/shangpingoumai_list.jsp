        ...
        <td>
            <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
                <tr align="left" bgcolor="#F2FDFF">
                    <td height="30" colspan="17" background="images/table_header.gif">商品购买列表</td>
                </tr>
            </table>
        </td>
    </tr>
                ...
                <tr align="right" bgcolor="#ebf0f7">
                    <td colspan="21">
                        <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1">
                            <tr align="left">
                                <td colspan="17">
                                    <form action="../shangpingoumai/shangpingoumaiList.do" name="myform" method="post">
                                        查询 销售单号：<input name="xiaoshoudanhao" type="text" id="xiaoshoudanhao"
                                                       class="form-control2"/>
                                        商品名称：<input name="shangpinmingcheng"
                                                    type="text"
                    ...
                    <td style="padding-left:0px; padding-right:0px;">
                        <table width="100%" border="1" align="center" cellpadding="4" cellspacing="1" bgcolor="#ebf0f7">
                            <tr>
                                ...
                                <td width='80' align='center' bgcolor='#ebf0f7'>状态</td>
                            ...
                            <c:forEach items="${list }" var="u">
                                ...
                                <tr align="center" bgcolor="#FFFFFF">
                                    ...
                                    <td align='center'>${u.issh}
                                        <c:if test="${u.iszf=='是'&&u.issh=='否'}"><input type="button" value="发货"
                                                                           onClick="javascript:location.href='../sh.jsp?id=${u.id}&yuan=${u.issh}&status=待收货&tablename=shangpingoumai'"/>
                                        </c:if>
                                    </td>
                                    <td>${u.status}</td>
