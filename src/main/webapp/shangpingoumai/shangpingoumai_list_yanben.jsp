...
<html xmlns="http://www.w3.org/1999/xhtml">
						...
						<tr align="left" >
							<td colspan="17">
								<form action="shangpingoumaiList.do" name="myform" method="post">
									��ѯ   ���۵��ţ�<input name="xiaoshoudanhao" type="text" id="xiaoshoudanhao" class="form-control2" />  ��Ʒ���ƣ�<input name="shangpinmingcheng" type="text" id="shangpinmingcheng" class="form-control2" />  ���ţ�<input name="bumen" type="text" id="bumen" class="form-control2" />
    ...
    <td align='center' bgcolor='#ebf0f7'>�ۿۼ۸�</td>
    ...
    <td align='center' bgcolor='#ebf0f7'>${u.iszf} </td>
                              ...
                              <td align="center"> <!--lianjie1--> <a class="btn btn-info btn-small" href="shangpingoumaiDetail.do?id=${u.id}">��ϸ</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
...
while(RS_result.next()){
		...
		�����ܼ۸�:<%=zongjiagez%>�� 
		 ...
		 <c:if test="${page.page>1}">
              <a href="shangpingoumaiList.do?page=1" >��ҳ</a>
             <a href="shangpingoumaiList.do?page=${page.page-1 }"> ��һҳ</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="shangpingoumaiList.do?page=${page.page+1 }">��һҳ</a>
			<a href="shangpingoumaiList.do?page=${page.totalPage }">ĩҳ</a>		    </c:if>		
	</c:if>
	</p>
