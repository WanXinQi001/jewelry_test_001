...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <td align='center' bgcolor='#ebf0f7'>${u.iszf} </td>
                              ...
                              <td align="center"> <a class="btn btn-info btn-small" href='../jifenzengjia/jifenzengjia_add.jsp?id=${u.id}'>添加积分增加</a> <a class="btn btn-info btn-small" href="shangpingoumaiDetail.do?id=${u.id}">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
