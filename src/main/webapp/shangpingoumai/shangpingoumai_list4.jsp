...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <td align='center'>${u.issh} <input type="button" value="审核" onClick="javascript:location.href='sh.jsp?id=${u.id}&yuan=${u.issh}&tablename=shangpingoumai'"/></td>
                              ...
                              <td align="center"><a class="btn btn-info btn-small" href="../jifenzengjia/jifenzengjia_add.jsp?id=${u.id }">积分增加</a>  <a class="btn btn-info btn-small" href="doUpdateShangpingoumai.do?id=${u.id }">金额计算</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
