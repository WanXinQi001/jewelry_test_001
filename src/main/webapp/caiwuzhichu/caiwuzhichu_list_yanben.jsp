...
<html xmlns="http://www.w3.org/1999/xhtml">
				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td colspan="17" background="images/table_header.gif">����֧���б�</td>
						</tr>
					</table>
				</td>
			</tr>
    ...
    <td align='center' bgcolor='#ebf0f7'>����</td>
    <td align='center' bgcolor='#ebf0f7'>�ɹ�֧��</td>
    <td align='center' bgcolor='#ebf0f7'>����֧��</td>
    <td align='center' bgcolor='#ebf0f7'>���ճɱ�</td>
    <td align='center' bgcolor='#ebf0f7'>����֧��</td>
    <td align='center' bgcolor='#ebf0f7'>��֧��</td>
    ...
    <td>${u.riqi}</td>
                              ...
                              <td align="center"> <!--lianjie1--> <a class="btn btn-info btn-small" href="caiwuzhichuDetail.do?id=${u.id}">��ϸ</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
...
while(RS_result.next()){
		...
		������֧��:<%=zongzhichuz%>�� 
		 ...
		 <c:if test="${page.page>1}">
              <a href="caiwuzhichuList.do?page=1" >��ҳ</a>
             <a href="caiwuzhichuList.do?page=${page.page-1 }"> ��һҳ</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="caiwuzhichuList.do?page=${page.page+1 }">��һҳ</a>
			<a href="caiwuzhichuList.do?page=${page.totalPage }">ĩҳ</a>		    </c:if>		
	</c:if>
	</p>
