...
<html xmlns="http://www.w3.org/1999/xhtml">
						...
						<tr align="left" >
							<td colspan="17">
								<form action="jinejisuanList.do" name="myform" method="post">
									��ѯ   ���۵��ţ�<input name="xiaoshoudanhao" type="text" id="xiaoshoudanhao" class="form-control2" />  �ܼ۸�<input name="zongjiage" type="text" id="zongjiage" class="form-control2" />
    ...
    <td>${u.xiaofeijine}</td>
		 ...
		 <c:if test="${page.page>1}">
              <a href="jinejisuanList.do?page=1" >��ҳ</a>
             <a href="jinejisuanList.do?page=${page.page-1 }"> ��һҳ</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="jinejisuanList.do?page=${page.page+1 }">��һҳ</a>
			<a href="jinejisuanList.do?page=${page.totalPage }">ĩҳ</a>		    </c:if>		
	</c:if>
	</p>
