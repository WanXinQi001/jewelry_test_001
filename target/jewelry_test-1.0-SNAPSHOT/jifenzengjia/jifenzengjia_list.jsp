...
<html xmlns="http://www.w3.org/1999/xhtml">
				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td height="30" colspan="17" background="images/table_header.gif">积分增加列表</td>
						</tr>
					</table>
				</td>
			</tr>
    ...
    <td>${u.jifen}</td>
                              ...
                              <td align="center"><a class="btn btn-info btn-small" href="doUpdateJifenzengjia.do?id=${u.id }">编辑</a>  <a class="btn btn-info btn-small" href="deleteJifenzengjia.do?id=${u.id }"
		 ...
		 <c:if test="${page.page>1}">
              <a href="jifenzengjiaList.do?page=1" >首页</a>
             <a href="jifenzengjiaList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="jifenzengjiaList.do?page=${page.page+1 }">下一页</a>
			<a href="jifenzengjiaList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
