...
<%--                    <td width="166" height="30">来自表</td>--%>
                ...
                <%
                    ...
                    while (RS_result.next()) {
                        i++;
                %>
                <tr align='center' bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#EDDCC2'"
                    onMouseOut="this.style.backgroundColor='#ffffff'" height="22">
                    <td width="50" height="45"><%=i %>
                    </td>
<%--                    <td height="45">[<%=RS_result.getString("biao")%>]</td>--%>
                    ...
                    %></td>
                    <td width="140" height="45" align="center"><%=RS_result.getString("addtime")%>
                    </td>
                    <td width="150" height="45" align="center"><a class="btn btn-info btn-small"
