...
<html>
 ...
 if(cx.equals("厂商")){sql="select * from changshangxinxi where zhanghao='"+uid+"' and mima='"+pwd+"'";}
if(cx.equals("会员")){sql="select * from huiyuanxinxi where kahao='"+uid+"' and mima='"+pwd+"' and issh='是'";}
