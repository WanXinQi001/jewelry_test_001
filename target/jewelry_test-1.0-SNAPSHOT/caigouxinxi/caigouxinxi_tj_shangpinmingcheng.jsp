...
<%
    ...
    // 按日统计，添加筛选条件只查询当月数据
    String dailySql = "SELECT shangpinmingcheng, COUNT(caigoushuliang) as bbb, DATE_FORMAT(caigouriqi, '%Y-%m-%d') as date " +
            "FROM caigouxinxi " +
            "WHERE YEAR(caigouriqi) =? AND MONTH(caigouriqi) =? " +
            "GROUP BY shangpinmingcheng, DATE_FORMAT(caigouriqi, '%Y-%m-%d')";
    ...
    // 按月统计
    String monthlySql = "SELECT shangpinmingcheng, COUNT(caigoushuliang) as bbb, DATE_FORMAT(caigouriqi, '%Y-%m') as month " +
            "FROM caigouxinxi " +
            "GROUP BY shangpinmingcheng, DATE_FORMAT(caigouriqi, '%Y-%m')";
    ...
    // 按年统计
    String yearlySql = "SELECT shangpinmingcheng, COUNT(caigoushuliang) as bbb, DATE_FORMAT(caigouriqi, '%Y') as year " +
            "FROM caigouxinxi " +
            "GROUP BY shangpinmingcheng, DATE_FORMAT(caigouriqi, '%Y')";
