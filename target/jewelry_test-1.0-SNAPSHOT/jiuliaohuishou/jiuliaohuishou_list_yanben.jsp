...
<html xmlns="http://www.w3.org/1999/xhtml">
				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td colspan="17" background="images/table_header.gif">���ϻ����б�</td>
						</tr>
					</table>
				</td>
			</tr>
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="jiuliaohuishouList.do" name="myform" method="post">
									��ѯ   ���յ��ţ�<input name="huishoudanhao" type="text" id="huishoudanhao" class="form-control2" />  ��Ʒ���ƣ�<input name="wupinmingcheng" type="text" id="wupinmingcheng" class="form-control2" />  �Ա�<input name="xingbie" type="text" id="xingbie" class="form-control2" />
						...
						<td style="padding-left:0px; padding-right:0px;"><table width="100%" border="1" align="center" cellpadding="4" cellspacing="1" bgcolor="#ebf0f7">
                          <tr>
                            ...
                            <td align='center' bgcolor='#ebf0f7'>���յ���</td>
    ...
    <td align='center' bgcolor='#ebf0f7'>${u.iszf} </td>
                              ...
                              <td align="center"> <!--lianjie1--> <a class="btn btn-info btn-small" href="jiuliaohuishouDetail.do?id=${u.id}">��ϸ</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <c:if test="${page.page>1}">
              <a href="jiuliaohuishouList.do?page=1" >��ҳ</a>
             <a href="jiuliaohuishouList.do?page=${page.page-1 }"> ��һҳ</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="jiuliaohuishouList.do?page=${page.page+1 }">��һҳ</a>
			<a href="jiuliaohuishouList.do?page=${page.totalPage }">ĩҳ</a>		    </c:if>		
	</c:if>
	</p>
