...
<html xmlns="http://www.w3.org/1999/xhtml">
				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td height="30" colspan="17" background="images/table_header.gif">财务支出列表</td>
						</tr>
					</table>
				</td>
			</tr>
			  ...
			  <table width="100%" border="1" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="caiwuzhichuList.do" name="myform" method="post">
    ...
    <td>${u.riqi}</td>
                              ...
                              <td align="center"><a class="btn btn-info btn-small" href="doUpdateCaiwuzhichu.do?id=${u.id }">编辑</a>  <a class="btn btn-info btn-small" href="deleteCaiwuzhichu.do?id=${u.id }"
										onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a> <a class="btn btn-info btn-small" href="caiwuzhichuDetail.do?id=${u.id}">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <%
			String sql="select * from caiwuzhichu where 1=1 ";
...
while(RS_result.next()){
						...
						zongzhichuz=zongzhichuz+Float.valueOf(RS_result.getString("zongzhichu")).floatValue();
		...
		共计总支出:<%=zongzhichuz%>； 
		 ...
		 <c:if test="${page.page>1}">
              <a href="caiwuzhichuList.do?page=1" >首页</a>
             <a href="caiwuzhichuList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="caiwuzhichuList.do?page=${page.page+1 }">下一页</a>
			<a href="caiwuzhichuList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
