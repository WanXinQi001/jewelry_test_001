...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateCaiwuzhichu.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="30" colspan="2" background="images/table_header.gif">修改财务支出<input type="hidden" name="id" value="${caiwuzhichu.id}" /></td>
						</tr>
		...
		<tr ><td width="200">日期：</td><td><input name='riqi' type='text' id='riqi' value='<%=connDbBean.getdate()%>' onblur='' readonly='readonly' onClick="WdatePicker({'dateFmt':'yyyy-MM-dd'})"  class="form-control" /></td></tr>
						...
						<script language="javascript">document.form1.bianhao.value='${caiwuzhichu.bianhao}';</script>
	<script language="javascript">document.form1.mingcheng.value='${caiwuzhichu.mingcheng}';</script>
	<script language="javascript">document.form1.caigouzhichu.value='${caiwuzhichu.caigouzhichu}';</script>
	<script language="javascript">document.form1.gongzizhichu.value='${caiwuzhichu.gongzizhichu}';</script>
	<script language="javascript">document.form1.huishouchengben.value='${caiwuzhichu.huishouchengben}';</script>
	<script language="javascript">document.form1.qitazhichu.value='${caiwuzhichu.qitazhichu}';</script>
	<script language="javascript">document.form1.zongzhichu.value='${caiwuzhichu.zongzhichu}';</script>
	<script language="javascript">document.form1.riqi.value='${caiwuzhichu.riqi}';</script>
