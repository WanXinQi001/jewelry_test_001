	...
	<body>
			<form action="addCaiwuguanli.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="30" colspan="2" background="images/table_header.gif">添加财务管理</td>
						</tr>
...
<script language=javascript >  
 ...
 function checkform(){  
	...
	var zongshouruobj = document.getElementById("zongshouru"); if(zongshouruobj.value!=""){ if(/^[0-9]+.?[0-9]*$/.test(zongshouruobj.value)){document.getElementById("clabelzongshouru").innerHTML=""; }else{document.getElementById("clabelzongshouru").innerHTML="&nbsp;&nbsp;<font color=red>必需数字型</font>"; return false;}}  
    var zongzhichuobj = document.getElementById("zongzhichu"); if(zongzhichuobj.value!=""){ if(/^[0-9]+.?[0-9]*$/.test(zongzhichuobj.value)){document.getElementById("clabelzongzhichu").innerHTML=""; }else{document.getElementById("clabelzongzhichu").innerHTML="&nbsp;&nbsp;<font color=red>必需数字型</font>"; return false;}}  
