...
<html xmlns="http://www.w3.org/1999/xhtml">
						...
						<tr align="left" >
							<td colspan="17">
								<form action="huiyuanxinxiList.do" name="myform" method="post">
									��ѯ   ���ţ�<input name="kahao" type="text" id="kahao" class="form-control2" />  ������<input name="xingming" type="text" id="xingming" class="form-control2" /> �Ա�<select name='xingbie' id='xingbie' class="form-control2"><option value="">����</option><option value="��">��</option><option value="Ů">Ů</option></select>
    ...
    <td align='center' bgcolor='#ebf0f7'>�ջ���ַ</td>
    <td align='center' bgcolor='#ebf0f7'>���ѽ��</td>
    <td align='center' bgcolor='#ebf0f7'>����</td>
    ...
    <td>${u.xiaofeijine}</td>
    <td>${u.jifen}</td>
    <td align='center'>${u.issh} <input type="button" value="���" onClick="javascript:location.href='sh.jsp?id=${u.id}&yuan=${u.issh}&tablename=huiyuanxinxi'"/></td>
                              <td align="center"> ${u.addtime } </td>
                              <td align="center"> <!--lianjie1--> <a class="btn btn-info btn-small" href="huiyuanxinxiDetail.do?id=${u.id}">��ϸ</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <c:if test="${page.page>1}">
              <a href="huiyuanxinxiList.do?page=1" >��ҳ</a>
             <a href="huiyuanxinxiList.do?page=${page.page-1 }"> ��һҳ</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="huiyuanxinxiList.do?page=${page.page+1 }">��һҳ</a>
			<a href="huiyuanxinxiList.do?page=${page.totalPage }">ĩҳ</a>		    </c:if>		
	</c:if>
	</p>
