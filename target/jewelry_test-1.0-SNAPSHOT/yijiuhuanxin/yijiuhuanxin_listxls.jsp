...
<jsp:useBean id="yijiuhuanxinhsgb" scope="page" class="com.bean.YijiuhuanxinBean" /> 

<%
response.setContentType("application/vnd.ms-excel");
response.addHeader("Content-Disposition", "attachment;filename=yijiuhuanxin.xls");
%>
<html>
  <head>
    <title>以旧换新</title>
  ...
  <body >
 <%
			String sql="select * from yijiuhuanxin  order by id desc";
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  <tr>
   ...
   <%		
				List pagelist3=yijiuhuanxinhsgb.getAllYijiuhuanxin(16);
