...
<form action="addYijiuhuanxin.do" name="form1" method="post">
    <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" style="border-collapse:collapse"
           bgcolor="#F2FDFF">
        <tr bgcolor="#E7E7E7">
            <td height="30" colspan="2" background="../images/table_header.gif">添加以旧换新</td>
        </tr>
        <tr>
            <td width="200">编号：</td>
        ...
        <tr>
            <td width="200">数量：</td>
            <td><input name='shuliang' type='text' id='shuliang' value='' onblur='' class="form-control"/></td>
        </tr>
        <tr>
            <td width="200">图片：</td>
        ...
        <tr>
            <td width="200">物品情况：</td>
            <td><textarea name='wupinqingkuang' cols='50' rows='5' id='wupinqingkuang' onblur='' class="form-control"
                          style="width:600px; height:80px;"></textarea></td>
        </tr>
        <tr>
            <td width="200">兑换物品：</td>
            <td><textarea name='duihuanwupin' cols='50' rows='5' id='duihuanwupin' onblur='' class="form-control"
                          style="width:600px; height:80px;"></textarea></td>
        </tr>
        ...
        <tr 0>
            ...
            <td><input name='faburiqi' type='text' id='faburiqi' value='<%=connDbBean.getdate()%>' onblur=''
