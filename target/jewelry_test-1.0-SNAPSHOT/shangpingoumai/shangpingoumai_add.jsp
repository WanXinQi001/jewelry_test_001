...
<form action="addShangpingoumai.do" name="form1" method="post">
    <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" style="border-collapse:collapse"
           bgcolor="#F2FDFF">
        <tr bgcolor="#E7E7E7">
            <td height="30" colspan="2" background="../images/table_header.gif">添加商品购买</td>
        </tr>
        <tr>
            <td width="200">销售单号：</td>
            <td><input name='xiaoshoudanhao' type='text' id='xiaoshoudanhao' value='<%=connDbBean.getID()%>' onblur=''
        ...
        <tr>
            <td width="200">部门：</td>
            <td><input name='bumen' type='text' id='bumen' value='' onblur='' class="form-control" readonly='readonly'/>
            </td>
        </tr>
        ...
        <tr>
            <td width="200">价格：</td>
            <td><input name='jiage' type='text' id='jiage' value='' onblur='' class="form-control" readonly='readonly'/>
            </td>
        </tr>
        ...
        <tr 5>
            ...
            <td><input name='huiyuandengji' type='text' id='huiyuandengji' value='' onblur='' class="form-control"/>
            </td>
        </tr>
        ...
        <tr 8>
            ...
            <td><input name='shouhuodizhi' type='text' id='shouhuodizhi' value='' onblur='' class="form-control"/></td>
        </tr>
