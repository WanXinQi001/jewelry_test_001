...
<form action="sh2.jsp?ac=1" name="form1" method="post">
    <table width="32%" height="193" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="9DC9FF"
           style="border-collapse:collapse">
        <tr>
            <td colspan="2">
                <div align="center">在线审核</div>
            </td>
        </tr>
        <tr>
            ...
            <td><select name="issh" id="issh">
                ...
                <input name="id" type="hidden" id="id" value="<%=request.getParameter("id")%>"><input name="tablename"
                                                                                                      type="hidden"
                                                                                                      id="tablename"
        ...
        <tr>
            ...
            <td height="80"><textarea name="shhf" cols="50" rows="5"
                                      id="shhf"><%=connDbBean.readzd(request.getParameter("tablename"), "shhf", "id", request.getParameter("id"))%></textarea>
            </td>
        </tr>
