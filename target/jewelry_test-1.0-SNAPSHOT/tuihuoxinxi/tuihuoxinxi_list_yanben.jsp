...
<html xmlns="http://www.w3.org/1999/xhtml">
						...
						<tr align="left" >
							<td colspan="17">
								<form action="tuihuoxinxiList.do" name="myform" method="post">
									��ѯ   ���۵��ţ�<input name="xiaoshoudanhao" type="text" id="xiaoshoudanhao" class="form-control2" />  ��Ʒ���ƣ�<input name="shangpinmingcheng" type="text" id="shangpinmingcheng" class="form-control2" />
    ...
    <td align='center' bgcolor='#ebf0f7'>${u.iszf} </td>
                              ...
                              <td align="center"> <!--lianjie1--> <a class="btn btn-info btn-small" href="tuihuoxinxiDetail.do?id=${u.id}">��ϸ</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <c:if test="${page.page>1}">
              <a href="tuihuoxinxiList.do?page=1" >��ҳ</a>
             <a href="tuihuoxinxiList.do?page=${page.page-1 }"> ��һҳ</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="tuihuoxinxiList.do?page=${page.page+1 }">��һҳ</a>
			<a href="tuihuoxinxiList.do?page=${page.totalPage }">ĩҳ</a>		    </c:if>		
	</c:if>
	</p>
