...
<html xmlns="http://www.w3.org/1999/xhtml">
			  ...
			  <table width="100%" border="1" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="yuangongxinxiList2.do" name="myform" method="post">
									查询   工号：<input name="gonghao" type="text" id="gonghao" class="form-control2" />  姓名：<input name="xingming" type="text" id="xingming" class="form-control2" /> 性别：<select name='xingbie' id='xingbie' class="form-control2"><option value="">所有</option><option value="男">男</option><option value="女">女</option></select>  部门：<input name="bumen" type="text" id="bumen" class="form-control2" />
    ...
    <td>${u.zhuzhi}</td>
                              ...
                              <td height="45" align="center"><a class="btn btn-info btn-small" href="doUpdateYuangongxinxi.do?id=${u.id }">编辑</a>   <a class="btn btn-info btn-small" href="yuangongxinxiDetail.do?id=${u.id }">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <c:if test="${page.page>1}">
              <a href="yuangongxinxiList2.do?page=1" >首页</a>
             <a href="yuangongxinxiList2.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="yuangongxinxiList2.do?page=${page.page+1 }">下一页</a>
			<a href="yuangongxinxiList2.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
