...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateYuangongxinxi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="30" colspan="2" background="images/table_header.gif">修改员工信息<input type="hidden" name="id" value="${yuangongxinxi.id}" /></td>
						</tr>
						<tr ><td width="200">工号：</td><td><input name='gonghao' type='text' id='gonghao' onblur='hsgcheck()' class="form-control" value='<%=(String)request.getSession().getAttribute("username")%>' readonly="readonly" />&nbsp;*<label id='clabelgonghao' style='margin-top:16px;' /></td></tr>
		...
		<tr ><td width="200">手机：</td><td><input name='shouji' type='text' id='shouji' value='' onblur='checkform()' class="form-control" />&nbsp;*<label id='clabelshouji' style='margin-top:16px;' /></td></tr>
		<tr ><td width="200">住址：</td><td><input name='zhuzhi' type='text' id='zhuzhi' value='' onblur='' size='50' class="form-control" style="width:600px;" /></td></tr>
	...
	<script language="javascript">document.form1.zhuzhi.value='${yuangongxinxi.zhuzhi}';</script>
